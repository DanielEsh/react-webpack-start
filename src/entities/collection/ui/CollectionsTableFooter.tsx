      ...
      <div className="flex items-center space-x-6 lg:space-x-8">
        <div className="flex items-center space-x-2">
          ...
          <button
            ...
            dir="ltr"
            data-state="closed"
            className="border-input ring-offset-background focus:ring-ring flex h-8 w-[70px] items-center justify-between rounded-md border bg-transparent px-3 py-2 text-sm shadow-sm placeholder:text-muted-foreground focus:outline-none focus:ring-1 disabled:cursor-not-allowed disabled:opacity-50"
          >
            <span>10</span>
            <svg
              width="15"
